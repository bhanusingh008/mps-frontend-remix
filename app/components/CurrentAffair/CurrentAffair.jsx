  ...
  return (
    <div className="mx-[10%] flex flex-col gap-1">
      ...
      <div className="flex flex-col sm:flex-row justify-center items-center gap-8 mt-8 mb-4">
        <div>
          <a
            className="text-[14px] sm:text-md min-w-[250px] flex items-center justify-center bg-white border border-[#3600a9] text-[#3600a9] px-8 py-4 rounded-xl cursor-pointer font-bold no-underline hover:bg-black/5 md:px-4 md:py-2 sm:px-2 sm:py-2"
        ...
        <div>
          <a
            className="text-[14px] sm:text-md min-w-[250px] flex items-center justify-center bg-[#3600a9] border border-[#3600a9] text-white px-8 py-4 rounded-xl cursor-pointer font-bold no-underline hover:bg-[#5b33d6] md:px-4 md:py-2 sm:px-2 sm:py-2"
